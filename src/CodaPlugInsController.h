...
/** `CodaPlugInsController` is the principal way of communicating with Coda.
 ...
 @since Availability: Coda 1.6 and later.
 */
...
/**
 ...
 @return
 local path of the current site, may be nil if unspecified or a site is not loaded.
 */
...
/**
 Returns the remote URL of the current site.
 @return
 The remote URL of the current site, may be nil if unspecified or a site is not loaded.
...
/**
 ...
 Return the human-readable name of your plug-in.
...
static NSString* const kValidatorMessageStringKey = @"ValidatorMessege";

/**
 @const kValidatorExplainationStringKey
 The key in a validator result dictionary whose value is a human-readable explaination string.
 */

static NSString* const kValidatorExplainationStringKey = @"ValidatorExplaination";
